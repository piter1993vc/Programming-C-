...
cout<<"laczna liczba butelek wina "<<more.Label()<<" "<<more.Sum()<<endl;
    ...
    Wine::Wine():string("testowe"),PairArray(10,10)
    {
        ile_lat=10;
    ...
    Wine::Wine(const char *l, int y,const int yr[],const int bot[]):string(l),PairArray(y,y),ile_lat(y)
     {
    ...
    Wine::Wine(const char *l,int y):string(l),PairArray(y,y),ile_lat(y)
     {
    ...
    void Wine::GetBottles()
     {
        ...
        for(int i=0;i<ile_lat;i++)
        {
            ...
            int rocznik;
            cin>>rocznik;
            PairArray::first()[i]=rocznik;
            cout<<"podaj liczbe butelek "<<endl;
            int butle;
            cin>>butle;
            PairArray::second()[i]=butle;
